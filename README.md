...
## 📊 Features
- **Easy Image Upload:** Simply select images from your computer.
- **Automated Stitching:** The application automatically combines your images for a seamless look.
- **Preview Before Saving:** View the stitched image before saving it.
- **Export Options:** Save your creations in various formats, including JPEG and PNG.
...
2. **Adjust Settings (Optional):**
   - You can tweak the stitching settings to customize the outcome. This includes rotation, scaling, or adjusting the overlay.

3. **Start Stitching:**
   - Hit the "Stitch" button to begin the process.
   - The app will show a progress bar as it works.

4. **Preview and Save:**
   - After stitching, preview your panoramic image.
   - Click "Save" and select your desired format and location.

## ❓ Troubleshooting
- **Application Crashes:** Ensure your system meets the requirements and that you have sufficient memory available.
...
- **Contribution:** Interested in contributing? Please read the guidelines found in the repository.
